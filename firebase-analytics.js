...
var FBAnalytics = (function(exports) {
  "use strict";
  
  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.getAnalytics = ze;
  exports.initializeAnalytics = Ve;
  exports.isSupported = Ke;
  exports.logEvent = Ze;
  exports.setAnalyticsCollectionEnabled = Je;
  exports.setConsent = Qe;
  exports.setCurrentScreen = We;
  exports.setDefaultEventParameters = Ye;
  exports.setUserId = Ge;
  exports.setUserProperties = Ue;
  exports.settings = He;
  var _firebaseApp = require("https://www.gstatic.com/firebasejs/9.15.0/firebase-app.js");
  var i;
  !function (e) {
  ...
  const me = e => {
    const t = e.getProvider("app").getImmediate(),
      a = (0, _firebaseApp._getProvider)(t, "installations").getImmediate();
    return {
  ...
  (0, _firebaseApp._registerComponent)(new I("installations", e => {
    const t = e.getProvider("app").getImmediate(),
      a = function (e) {
    ...
    return {
      app: t,
      appConfig: a,
      heartbeatServiceProvider: (0, _firebaseApp._getProvider)(t, "heartbeat"),
      _delete: () => Promise.resolve()
    };
  }, "PUBLIC")), (0, _firebaseApp._registerComponent)(new I("installations-internal", me, "PRIVATE")), (0, _firebaseApp.registerVersion)(N, "0.6.0"), (0, _firebaseApp.registerVersion)(N, "0.6.0", "esm2017");
    ...
    try {
      const t = await async function (e) {
        ...
        const {
          ...
          r = "https://firebase.googleapis.com/v1alpha/projects/-/apps/{app-id}/webConfig".replace("{app-id}", n),
          o = await fetch(r, i);
  ...
  async function $e(e, t, n, a, i, r, o) {
    ...
    (function (e) {
      ...
      for (const n of Object.values(t)) if (n.src && n.src.includes(we) && n.src.includes(e)) return n;
      return null;
    })(r) || function (e, t) {
  ...
  function ze(e = (0, _firebaseApp.getApp)()) {
    e = v(e);
    const t = (0, _firebaseApp._getProvider)(e, "analytics");
    return t.isInitialized() ? t.getImmediate() : Ve(e);
  }
  function Ve(e, t = {}) {
    const a = (0, _firebaseApp._getProvider)(e, "analytics");
    if (a.isInitialized()) {
  ...
  function Ze(e, t, n, a) {
    e = v(e), async function (e, t, n, a, i) {
      if (i && i.global) e("event", n, a);else {
        const i = await t;
  ...
  (0, _firebaseApp._registerComponent)(new I("analytics", (e, {
    options: t
  }) => qe(e.getProvider("app").getImmediate(), e.getProvider("installations-internal").getImmediate(), t), "PUBLIC")), (0, _firebaseApp._registerComponent)(new I("analytics-internal", function (e) {
    try {
  ...
  }, "PRIVATE")), (0, _firebaseApp.registerVersion)(Xe, "0.9.0"), (0, _firebaseApp.registerVersion)(Xe, "0.9.0", "esm2017");
  return "default" in exports ? exports.default : exports;
})({});
if (typeof define === 'function' && define.amd) define([], function() { return FBAnalytics; });
else if (typeof module === 'object' && typeof exports === 'object') module.exports = FBAnalytics;
